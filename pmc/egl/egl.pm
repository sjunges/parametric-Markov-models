...
module partyA
	...
	[receiveA] phase=1 & n=0  -> p0 : (b0'=L)  + (1-p0) : (b20'=L);
	[receiveA] phase=1 & n=1  -> p1 : (b1'=L)  + (1-p1) : (b21'=L);
	[receiveA] phase=1 & n=2  -> p2 : (b2'=L)  + (1-p2) : (b22'=L);
	[receiveA] phase=1 & n=3  -> p3 : (b3'=L)  + (1-p3) : (b23'=L);
	[receiveA] phase=1 & n=4  -> p4 : (b4'=L)  + (1-p4) : (b24'=L);
	[receiveA] phase=1 & n=5  -> p5 : (b5'=L)  + (1-p5) : (b25'=L);
	[receiveA] phase=1 & n=6  -> p6 : (b6'=L)  + (1-p6) : (b26'=L);
	[receiveA] phase=1 & n=7  -> p7 : (b7'=L)  + (1-p7) : (b27'=L);
	[receiveA] phase=1 & n=8  -> p8 : (b8'=L)  + (1-p8) : (b28'=L);
	[receiveA] phase=1 & n=9  -> p9 : (b9'=L)  + (1-p9) : (b29'=L);
	[receiveA] phase=1 & n=10 -> p10 : (b10'=L) + (1-p10) : (b30'=L);
	[receiveA] phase=1 & n=11 -> p11 : (b11'=L) + (1-p11) : (b31'=L);
	[receiveA] phase=1 & n=12 -> p12 : (b12'=L) + (1-p12) : (b32'=L);
	[receiveA] phase=1 & n=13 -> p13 : (b13'=L) + (1-p13) : (b33'=L);
	[receiveA] phase=1 & n=14 -> p14 : (b14'=L) + (1-p14) : (b34'=L);
	[receiveA] phase=1 & n=15 -> p15 : (b15'=L) + (1-p15) : (b35'=L);
	[receiveA] phase=1 & n=16 -> p16 : (b16'=L) + (1-p16) : (b36'=L);
	[receiveA] phase=1 & n=17 -> p17 : (b17'=L) + (1-p17) : (b37'=L);
	[receiveA] phase=1 & n=18 -> p18 : (b18'=L) + (1-p18) : (b38'=L);
	[receiveA] phase=1 & n=19 -> p19 : (b19'=L) + (1-p19) : (b39'=L);
...
module partyB=partyA[b0 =a0 ,b1 =a1 ,b2 =a2 ,b3 =a3 ,b4 =a4 ,b5 =a5 ,b6 =a6 ,b7 =a7 ,b8 =a8 ,b9 =a9 ,
                     ...
                     p0 =q0 ,p1 =q1 ,p2 =q2 ,p3 =q3 ,p4 =q4 ,p5 =q5 ,p6 =q6 ,p7 =q7 ,p8 =q8 ,p9 =q9 ,
                     p10=q10,p11=q11,p12=q12,p13=q13,p14=q14,p15=q15,p16=q16,p17=q17,p18=q18,p19=q19,
                     receiveA=receiveB]
endmodule
